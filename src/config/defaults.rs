...
use crate::config::{SirenConfig, GeneralConfig, StyleConfig, LanguageConfig};
...
pub fn create_default_config() -> SirenConfig {
    ...
    config.languages.insert(Language::Rust, create_rust_config());
    config.languages.insert(Language::Python, create_python_config());
    config.languages.insert(Language::JavaScript, create_javascript_config());
    config.languages.insert(Language::TypeScript, create_typescript_config());
...
fn add_default_rust_tools(tools: &mut HashMap<String, ToolConfig>) {
    // rustfmt
    tools.insert("rustfmt".to_string(), ToolConfig {
        enabled: true,
        extra_args: vec![],
    ...
    // clippy
    tools.insert("clippy".to_string(), ToolConfig {
        enabled: true,
    ...
    // cargo fix
    tools.insert("cargo-fix".to_string(), ToolConfig {
        enabled: true,
        extra_args: vec![],
        env_vars: HashMap::new(),
        executable_path: None,
...
fn add_default_python_tools(tools: &mut HashMap<String, ToolConfig>) {
    // black
    tools.insert("black".to_string(), ToolConfig {
        enabled: true,
        extra_args: vec![],
        env_vars: HashMap::new(),
        executable_path: None,
    ...
    // ruff
    tools.insert("ruff".to_string(), ToolConfig {
        enabled: true,
        extra_args: vec![],
        env_vars: HashMap::new(),
        executable_path: None,
    ...
    // mypy
    tools.insert("mypy".to_string(), ToolConfig {
        enabled: true,
...
fn add_default_javascript_tools(tools: &mut HashMap<String, ToolConfig>) {
    // prettier
    tools.insert("prettier".to_string(), ToolConfig {
        enabled: true,
        extra_args: vec![],
        env_vars: HashMap::new(),
        executable_path: None,
    ...
    // eslint
    tools.insert("eslint".to_string(), ToolConfig {
        enabled: true,
        extra_args: vec![],
        env_vars: HashMap::new(),
        executable_path: None,
